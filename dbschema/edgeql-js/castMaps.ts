															...
															: T extends _std.$bytes
																...
																: T extends _std.$bool
																	...
																	: T extends _std.$bigint
																		? _std.$bigint
																		: T extends _std.$JsonEmpty
																			? _std.$JsonEmpty
																			: T extends _schema.$Volatility
																				? _schema.$Volatility
																				: T extends _schema.$TypeModifier
																					? _schema.$TypeModifier
																					: T extends _schema.$TriggerTiming
																						? _schema.$TriggerTiming
																						: T extends _schema.$TriggerScope
																							? _schema.$TriggerScope
																							: T extends _schema.$TriggerKind
																								? _schema.$TriggerKind
																								: T extends _schema.$TargetDeleteAction
																									? _schema.$TargetDeleteAction
																									: T extends _schema.$SourceDeleteAction
																										? _schema.$SourceDeleteAction
																										: T extends _schema.$RewriteKind
																											? _schema.$RewriteKind
																											: T extends _schema.$ParameterKind
																												? _schema.$ParameterKind
																												: T extends _schema.$OperatorKind
																													? _schema.$OperatorKind
																													: T extends _schema.$MigrationGeneratedBy
																														? _schema.$MigrationGeneratedBy
																														: T extends _schema.$Cardinality
																															? _schema.$Cardinality
																															: T extends _schema.$AccessPolicyAction
																																? _schema.$AccessPolicyAction
																																: T extends _schema.$AccessKind
																																	? _schema.$AccessKind
																																	: T extends _fts.$document
																																		? _fts.$document
																																		: T extends _fts.$Weight
																																			? _fts.$Weight
																																			: T extends _fts.$PGLanguage
																																				? _fts.$PGLanguage
																																				: T extends _fts.$LuceneLanguage
																																					? _fts.$LuceneLanguage
																																					: T extends _fts.$Language
																																						? _fts.$Language
																																						: T extends _fts.$ElasticLanguage
																																							? _fts.$ElasticLanguage
																																							: T extends _auth.$SMTPSecurity
																																								? _auth.$SMTPSecurity
																																								: T extends _auth.$JWTAlgo
																																									? _auth.$JWTAlgo
																																									: T extends _auth.$FlowType
																																										? _auth.$FlowType
																																										: T extends _default.$CloudProvider
																																											? _default.$CloudProvider
																																											: T extends _cfg.$memory
																																												? _cfg.$memory
																																												: T extends _cfg.$ConnectionTransport
																																													? _cfg.$ConnectionTransport
																																													: T extends _cfg.$AllowBareDDL
																																														? _cfg.$AllowBareDDL
																																														: T extends _cal.$relative_duration
																																															? _cal.$relative_durationλIAssignableBy
																																															: T extends _cal.$local_time
																																																? _cal.$local_time
																																																: T extends _cal.$local_datetime
																																																	? _cal.$local_datetimeλIAssignableBy
																																																	: T extends _cal.$local_date
																																																		? _cal.$local_date
																																																		: T extends _cal.$date_duration
																																																			? _cal.$date_duration
																																																			: never;
																																											...
																																											: T extends _cfg.$memory
																																												...
																																												: T extends _cfg.$ConnectionTransport
																																													...
																																													: T extends _cfg.$AllowBareDDL
																																														? _cfg.$AllowBareDDL
																																														: T extends _cal.$relative_duration
																																															? _cal.$relative_durationλICastableTo
																																															: T extends _cal.$local_time
																																																? _cal.$local_time
																																																: T extends _cal.$local_datetime
																																																	? _cal.$local_datetimeλICastableTo
																																																	: T extends _cal.$local_date
																																																		? _cal.$local_date
																																																		: T extends _cal.$date_duration
																																																			? _cal.$date_duration
...
export type scalarWithConstType<T extends $.ScalarType, TsConstType> = $.ScalarType<
	T['__name__'],
	T['__tstype__'],
	T['__tsargtype__'],
	TsConstType
								...
								: T extends edgedb.LocalDate
									...
									: T extends edgedb.LocalTime
										...
										: T extends edgedb.RelativeDuration
											...
											: T extends edgedb.DateDuration
												? scalarWithConstType<_cal.$date_duration, T>
												: T extends edgedb.ConfigMemory
													? scalarWithConstType<_cfg.$memory, T>
													: T extends edgedb.Range<infer E>
														? $.RangeType<literalToScalarType<E>>
														: T extends edgedb.MultiRange<infer E>
