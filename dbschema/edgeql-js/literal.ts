...
export function literal<T extends BaseType>(type: T, value: BaseTypeToTsType<T>): $expr_Literal<T> {
...
export function $getTypeByName(name: string): (val: any) => $expr_Literal<ScalarType> {
