...
function set<Expr extends $.ObjectTypeSet, Exprs extends [Expr, ...Expr[]]>(
	...
	>
>;
function set<Expr extends $.TypeSet<$.AnyTupleType>, Exprs extends [Expr, ...Expr[]]>(
	...exprs: Exprs
): $expr_Set<getSetTypeFromExprs<Exprs>>;
function set<
...
function set(..._exprs: any[]) {
	...
	return $expressionify({
		...
		__element__: exprs.map((expr) => expr.__element__ as any).reduce(getSharedParent),
