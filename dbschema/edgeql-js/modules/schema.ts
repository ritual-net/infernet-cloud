...
export type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is Container]": $.LinkDesc<_default.$Container, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is InfernetNode]": $.LinkDesc<_default.$InfernetNode, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is ServiceAccount]": $.LinkDesc<_default.$ServiceAccount, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Cluster]": $.LinkDesc<_default.$Cluster, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is AWSCluster]": $.LinkDesc<_default.$AWSCluster, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is AWSServiceAccount]": $.LinkDesc<_default.$AWSServiceAccount, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is ContainerTemplate]": $.LinkDesc<_default.$ContainerTemplate, $.Cardinality.Many, {}, false, false,  false, false>;
