...
const MultiRangeExprAlias: $.$expr_PathNode<
	...
	null
> = _.syntax.$PathNode($.$toSet($MultiRangeExprAlias, $.Cardinality.Many), null);
	...
	$SourceλShape &
		...
		$AnnotationSubjectλShape & {
			...
			'<__type__[is ext::auth::EmailPasswordProviderConfig]': $.LinkDesc<
				_auth.$EmailPasswordProviderConfig,
				$.Cardinality.Many,
				{},
				false,
				false,
			...
			'<__type__[is User]': $.LinkDesc<
				...
				false
			>;
			'<__type__[is __default::current_user]': $.LinkDesc<
				...
				false
			>;
			'<__type__[is current_user]': $.LinkDesc<
				...
				false
			>;
			'<__type__[is Container]': $.LinkDesc<
				_default.$Container,
				$.Cardinality.Many,
				{},
				false,
				...
				false
			>;
			'<__type__[is InfernetNode]': $.LinkDesc<
				_default.$InfernetNode,
				$.Cardinality.Many,
				{},
				false,
				false,
				...
				false
			>;
			'<__type__[is ServiceAccount]': $.LinkDesc<
				_default.$ServiceAccount,
				$.Cardinality.Many,
				{},
				false,
				false,
			...
			'<__type__[is Cluster]': $.LinkDesc<
				...
				false
			>;
			'<__type__[is AWSCluster]': $.LinkDesc<
				_default.$AWSCluster,
				$.Cardinality.Many,
				{},
				false,
				...
				false
			>;
			'<__type__[is AWSServiceAccount]': $.LinkDesc<
				_default.$AWSServiceAccount,
				$.Cardinality.Many,
				{},
				false,
				false,
				...
				false
			>;
			'<__type__[is ContainerTemplate]': $.LinkDesc<
				_default.$ContainerTemplate,
				$.Cardinality.Many,
				{},
				false,
				false,
				...
				false
			>;
			'<__type__[is GCPCluster]': $.LinkDesc<
				_default.$GCPCluster,
				$.Cardinality.Many,
				{},
				false,
				...
				false
			>;
			'<__type__[is GCPServiceAccount]': $.LinkDesc<
				_default.$GCPServiceAccount,
				$.Cardinality.Many,
				{},
				false,
				false,
