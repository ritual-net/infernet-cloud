...
> = $.$expr_Function<
	...
	>
>;
type base64_encodeλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$bytes>>> =
 ...
 * Encode given data as a base64 string
 */
function base64_encode<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$bytes>>>(
	data: P1
...
> = $.$expr_Function<
	...
	>
>;
type base64_decodeλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>> =
 ...
 * Decode the byte64-encoded byte string and return decoded bytes.
 */
function base64_decode<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>>(
	data: P1
