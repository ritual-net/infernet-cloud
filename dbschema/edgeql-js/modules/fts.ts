...
const Language: $Language = $.makeType<$Language>(
	_.spec,
	'4e291f3c-c871-56fb-b07a-0e841552c500',
	_.syntax.literal
);
...
const LuceneLanguage: $LuceneLanguage = $.makeType<$LuceneLanguage>(
	_.spec,
	'30696cb3-efd2-5146-8338-9ccc4ada0523',
	_.syntax.literal
);
...
const PGLanguage: $PGLanguage = $.makeType<$PGLanguage>(
	_.spec,
	'946d99dc-5330-5d27-9c74-3e8e522e0df3',
	_.syntax.literal
);
...
const Weight: $Weight = $.makeType<$Weight>(
	_.spec,
	'6ff6d8f7-ff4e-5653-af31-2976f6d87159',
	_.syntax.literal
);
...
>(_.spec, '82a03701-64a0-526d-9e43-397ce1e2022f', _.syntax.literal);
	...
	const {
	...
	} = _.syntax.$resolveOverload('fts::with_options', args, _.spec, [
		{
			...
			namedArgs: {
				...
				weight_category: {
					typeId: '6ff6d8f7-ff4e-5653-af31-2976f6d87159',
					optional: true,
					setoftype: false,
					variadic: false,
				},
