...
> = $.$expr_Function<
	...
	>
>;
type assert_singleλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>> =
	$.$expr_Function<
		$.getPrimitiveBaseType<_.castMaps.literalToTypeSet<P1>['__element__']>,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
 ...
 * Check that the input set contains at most one element, raise
         CardinalityViolationError otherwise.
 */
function assert_single<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>>(
	input: P1
...
>;
type assert_existsλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>> =
	$.$expr_Function<
		$.getPrimitiveBaseType<_.castMaps.literalToTypeSet<P1>['__element__']>,
		$.cardutil.overrideLowerBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
 ...
 * Check that the input set contains at least one element, raise
         CardinalityViolationError otherwise.
 */
function assert_exists<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>>(
	input: P1
...
> = $.$expr_Function<
	...
	$.Cardinality.Many
>;
type assert_distinctλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>> =
	$.$expr_Function<
		$.getPrimitiveBaseType<_.castMaps.literalToTypeSet<P1>['__element__']>,
		$.Cardinality.Many
	>;
 ...
 * Check that the input set is a proper set, i.e. all elements
         are unique
 */
function assert_distinct<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>>(
	input: P1
...
> = $.$expr_Function<
	...
	>
>;
type assertλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bool>>> = $.$expr_Function<
	$bool,
	$.cardutil.paramCardinality<P1>
>;
/**
...
type lenλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>> = $.$expr_Function<
	$number,
	$.cardutil.paramCardinality<P1>
>;
type lenλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bytes>>> = $.$expr_Function<
	$number,
	$.cardutil.paramCardinality<P1>
>;
type lenλFuncExpr3<P1 extends $.TypeSet<$.ArrayType<$.NonArrayType>>> = $.$expr_Function<
	$number,
	$.cardutil.paramCardinality<P1>
>;
/**
 ...
 */
function len<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>>(str: P1): lenλFuncExpr<P1>;
/**
 * A polymorphic function to calculate a "length" of its first argument.
 */
 ...
 * A polymorphic function to calculate a "length" of its first argument.
 */
function len<P1 extends $.TypeSet<$.ArrayType<$.NonArrayType>>>(array: P1): lenλFuncExpr3<P1>;
...
type sumλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bigint>>> = $.$expr_Function<
	$bigint,
	$.Cardinality.One
>;
type sumλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>> = $.$expr_Function<
	$number,
	$.Cardinality.One
>;
type sumλFuncExpr3<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$decimalλICastableTo>>> =
	$.$expr_Function<$decimal, $.Cardinality.One>;
/**
 * Return the sum of the set of numbers.
 */
function sum<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bigint>>>(s: P1): sumλFuncExpr<P1>;
/**
 * Return the sum of the set of numbers.
 */
function sum<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>>(s: P1): sumλFuncExpr2<P1>;
/**
 * Return the sum of the set of numbers.
 */
function sum<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$decimalλICastableTo>>>(
	s: P1
): sumλFuncExpr3<P1>;
...
type countλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>> =
...
type minλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$anyreal>>> = $.$expr_Function<
	$anyreal,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type minλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.EnumType>>> = $.$expr_Function<
	$.EnumType,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type minλFuncExpr3<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>> = $.$expr_Function<
	$str,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type minλFuncExpr4<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$datetime>>> = $.$expr_Function<
	$datetime,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type minλFuncExpr5<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$duration>>> = $.$expr_Function<
	$duration,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type minλFuncExpr6<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_date>>> =
	$.$expr_Function<
		_cal.$local_date,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type minλFuncExpr7<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_time>>> =
	$.$expr_Function<
		_cal.$local_time,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type minλFuncExpr8<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$date_duration>>> =
	$.$expr_Function<
		_cal.$date_duration,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type minλFuncExpr9<P1 extends $.TypeSet<$.ArrayType<_cal.$local_datetimeλICastableTo>>> =
	$.$expr_Function<
		$.ArrayType<_cal.$local_datetime>,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type minλFuncExpr10<P1 extends $.TypeSet<$.ArrayType<_cal.$local_date>>> = $.$expr_Function<
	$.ArrayType<_cal.$local_date>,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type minλFuncExpr11<P1 extends $.TypeSet<$.ArrayType<_cal.$local_time>>> = $.$expr_Function<
	$.ArrayType<_cal.$local_time>,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type minλFuncExpr12<P1 extends $.TypeSet<$.ArrayType<_cal.$relative_durationλICastableTo>>> =
	$.$expr_Function<
		$.ArrayType<_cal.$relative_duration>,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type minλFuncExpr13<P1 extends $.TypeSet<$.ArrayType<_cal.$date_duration>>> = $.$expr_Function<
...
> = $.$expr_Function<
	...
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type minλFuncExpr16<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>> =
	$.$expr_Function<
		$.getPrimitiveBaseType<_.castMaps.literalToTypeSet<P1>['__element__']>,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
 ...
 * Return the smallest value of the input set.
 */
function min<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>>(vals: P1): minλFuncExpr3<P1>;
/**
 * Return the smallest value of the input set.
 */
 ...
 * Return the smallest value of the input set.
 */
function min<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_date>>>(
	vals: P1
): minλFuncExpr6<P1>;
/**
 * Return the smallest value of the input set.
 */
function min<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_time>>>(
	vals: P1
): minλFuncExpr7<P1>;
/**
 * Return the smallest value of the input set.
 */
function min<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$date_duration>>>(
	vals: P1
): minλFuncExpr8<P1>;
/**
 * Return the smallest value of the input set.
 */
function min<P1 extends $.TypeSet<$.ArrayType<_cal.$local_datetimeλICastableTo>>>(
	vals: P1
): minλFuncExpr9<P1>;
/**
 * Return the smallest value of the input set.
 */
function min<P1 extends $.TypeSet<$.ArrayType<_cal.$local_date>>>(vals: P1): minλFuncExpr10<P1>;
/**
 * Return the smallest value of the input set.
 */
function min<P1 extends $.TypeSet<$.ArrayType<_cal.$local_time>>>(vals: P1): minλFuncExpr11<P1>;
/**
 * Return the smallest value of the input set.
 */
function min<P1 extends $.TypeSet<$.ArrayType<_cal.$relative_durationλICastableTo>>>(
	vals: P1
): minλFuncExpr12<P1>;
/**
 * Return the smallest value of the input set.
 */
function min<P1 extends $.TypeSet<$.ArrayType<_cal.$date_duration>>>(vals: P1): minλFuncExpr13<P1>;
/**
 * Return the smallest value of the input set.
 */
function min<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_datetimeλICastableTo>>>(
	vals: P1
): minλFuncExpr14<P1>;
/**
 * Return the smallest value of the input set.
 */
function min<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$relative_durationλICastableTo>>>(
	vals: P1
): minλFuncExpr15<P1>;
/**
 * Return the smallest value of the input set.
...
type maxλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$anyreal>>> = $.$expr_Function<
	$anyreal,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.EnumType>>> = $.$expr_Function<
	$.EnumType,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr3<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>> = $.$expr_Function<
	$str,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr4<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$datetime>>> = $.$expr_Function<
	$datetime,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr5<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$duration>>> = $.$expr_Function<
	$duration,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr6<P1 extends $.TypeSet<$.ArrayType<_cal.$relative_durationλICastableTo>>> =
	$.$expr_Function<
		$.ArrayType<_cal.$relative_duration>,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type maxλFuncExpr7<P1 extends $.TypeSet<$.ArrayType<_cal.$date_duration>>> = $.$expr_Function<
	$.ArrayType<_cal.$date_duration>,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr8<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_date>>> =
	$.$expr_Function<
		_cal.$local_date,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type maxλFuncExpr9<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_time>>> =
	$.$expr_Function<
		_cal.$local_time,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type maxλFuncExpr10<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$date_duration>>> =
	$.$expr_Function<
		_cal.$date_duration,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type maxλFuncExpr11<P1 extends $.TypeSet<$.ArrayType<_cal.$local_datetimeλICastableTo>>> =
	$.$expr_Function<
		$.ArrayType<_cal.$local_datetime>,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
type maxλFuncExpr12<P1 extends $.TypeSet<$.ArrayType<_cal.$local_date>>> = $.$expr_Function<
	$.ArrayType<_cal.$local_date>,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr13<P1 extends $.TypeSet<$.ArrayType<_cal.$local_time>>> = $.$expr_Function<
	$.ArrayType<_cal.$local_time>,
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr14<
...
> = $.$expr_Function<
	...
	$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr16<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>> =
	$.$expr_Function<
		$.getPrimitiveBaseType<_.castMaps.literalToTypeSet<P1>['__element__']>,
		$.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
	>;
 ...
 * Return the greatest value of the input set.
 */
function max<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>>(vals: P1): maxλFuncExpr3<P1>;
/**
 * Return the greatest value of the input set.
 */
 ...
 * Return the smallest value of the input set.
 */
function max<P1 extends $.TypeSet<$.ArrayType<_cal.$relative_durationλICastableTo>>>(
	vals: P1
): maxλFuncExpr6<P1>;
/**
 * Return the smallest value of the input set.
 */
function max<P1 extends $.TypeSet<$.ArrayType<_cal.$date_duration>>>(vals: P1): maxλFuncExpr7<P1>;
/**
 * Return the smallest value of the input set.
 */
function max<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_date>>>(
	vals: P1
): maxλFuncExpr8<P1>;
/**
 * Return the smallest value of the input set.
 */
function max<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_time>>>(
	vals: P1
): maxλFuncExpr9<P1>;
/**
 * Return the greatest value of the input set.
 */
function max<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$date_duration>>>(
	vals: P1
): maxλFuncExpr10<P1>;
/**
 * Return the smallest value of the input set.
 */
function max<P1 extends $.TypeSet<$.ArrayType<_cal.$local_datetimeλICastableTo>>>(
	vals: P1
): maxλFuncExpr11<P1>;
/**
 * Return the smallest value of the input set.
 */
function max<P1 extends $.TypeSet<$.ArrayType<_cal.$local_date>>>(vals: P1): maxλFuncExpr12<P1>;
/**
 * Return the smallest value of the input set.
 */
function max<P1 extends $.TypeSet<$.ArrayType<_cal.$local_time>>>(vals: P1): maxλFuncExpr13<P1>;
/**
 * Return the smallest value of the input set.
 */
function max<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$local_datetimeλICastableTo>>>(
	vals: P1
): maxλFuncExpr14<P1>;
/**
 * Return the greatest value of the input set.
 */
function max<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$relative_durationλICastableTo>>>(
	vals: P1
): maxλFuncExpr15<P1>;
/**
 * Return the greatest value of the input set.
...
type allλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bool>>> = $.$expr_Function<
	$bool,
	$.Cardinality.One
>;
/**
 ...
 */
function all<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bool>>>(vals: P1): allλFuncExpr<P1>;
...
type anyλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bool>>> = $.$expr_Function<
	$bool,
	$.Cardinality.One
>;
/**
 ...
 */
function any<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bool>>>(vals: P1): anyλFuncExpr<P1>;
...
type enumerateλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>> =
	$.$expr_Function<
 ...
 */
function enumerate<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>>(
	vals: P1
...
type roundλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>> = $.$expr_Function<
	$number,
	$.cardutil.paramCardinality<P1>
>;
type roundλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bigint>>> = $.$expr_Function<
	$bigint,
	$.cardutil.paramCardinality<P1>
>;
type roundλFuncExpr3<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$decimalλICastableTo>>> =
 ...
 * Round to the nearest value.
 */
function round<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$decimalλICastableTo>>>(
	val: P1
): roundλFuncExpr3<P1>;
/**
 * Round to the nearest value.
...
function array_get<
	...
	P1 extends $.TypeSet<$.ArrayType<_cal.$relative_durationλICastableTo>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
>(namedArgs: NamedArgs, array: P1, idx: P2): array_getλFuncExpr<NamedArgs, P1, P2>;
/**
 * Return the element of *array* at the specified *index*.
 */
function array_get<
...
function array_get<
	...
	P1 extends $.TypeSet<$.ArrayType<_cal.$local_datetimeλICastableTo>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
>(namedArgs: NamedArgs, array: P1, idx: P2): array_getλFuncExpr3<NamedArgs, P1, P2>;
/**
 * Return the element of *array* at the specified *index*.
 */
function array_get<
...
function array_get<
	...
	P1 extends $.TypeSet<$.ArrayType<$decimalλICastableTo>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
>(namedArgs: NamedArgs, array: P1, idx: P2): array_getλFuncExpr5<NamedArgs, P1, P2>;
/**
 * Return the element of *array* at the specified *index*.
 */
function array_get<
...
function array_get<
	...
	P1 extends $.TypeSet<$.ArrayType<$.ObjectType>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
>(namedArgs: NamedArgs, array: P1, idx: P2): array_getλFuncExpr7<NamedArgs, P1, P2>;
/**
 * Return the element of *array* at the specified *index*.
 */
function array_get<
...
function array_get<
	...
	P1 extends $.TypeSet<$.ArrayType<$.AnyTupleType>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
>(namedArgs: NamedArgs, array: P1, idx: P2): array_getλFuncExpr9<NamedArgs, P1, P2>;
/**
 * Return the element of *array* at the specified *index*.
 */
function array_get<
...
function array_get<
	...
	P1 extends $.TypeSet<$.ArrayType<$.NonArrayType>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
>(namedArgs: NamedArgs, array: P1, idx: P2): array_getλFuncExpr11<NamedArgs, P1, P2>;
/**
 * Return the element of *array* at the specified *index*.
 */
function array_get<
...
type bit_notλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>> = $.$expr_Function<
	$number,
	$.cardutil.paramCardinality<P1>
>;
/**
...
type array_aggλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.NonArrayType>>> =
	$.$expr_Function<
 ...
 */
function array_agg<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.NonArrayType>>>(
	s: P1
...
type array_unpackλFuncExpr<P1 extends $.TypeSet<$.ArrayType<$.NonArrayType>>> = $.$expr_Function<
	$.getPrimitiveNonArrayBaseType<P1['__element__']['__element__']>,
	$.Cardinality.Many
>;
/**
...
type duration_to_secondsλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$duration>>> =
	$.$expr_Function<$decimal, $.cardutil.paramCardinality<P1>>;
/**
 * Return duration as total number of seconds in interval.
 */
function duration_to_seconds<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$duration>>>(
	dur: P1
...
type json_typeofλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$json>>> =
...
type json_array_unpackλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$json>>> =
	$.$expr_Function<$json, $.Cardinality.Many>;
/**
 * Return elements of JSON array as a set of `json`.
 */
function json_array_unpack<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$json>>>(
	array: P1
...
type json_object_unpackλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$json>>> =
	$.$expr_Function<$.TupleType<[$str, $json]>, $.Cardinality.Many>;
/**
 * Return set of key/value tuples that make up the JSON object.
 */
function json_object_unpack<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$json>>>(
	obj: P1
...
type json_object_packλFuncExpr<P1 extends $.TypeSet<$.TupleType<[$str, $json]>>> = $.$expr_Function<
	$json,
	$.Cardinality.One
>;
/**
...
>(namedArgs: NamedArgs, json: P1, ...path: P2): json_getλFuncExpr<NamedArgs, P1, P2>;
/**
 * Return the JSON value at the end of the specified path or an empty set.
 */
function json_get<
...
>(namedArgs: NamedArgs, target: P1, ...path: P2): json_setλFuncExpr<NamedArgs, P1, P2>;
/**
 * Return an updated JSON target with a new value.
 */
function json_set<
...
type range_unpackλFuncExpr<P1 extends $.TypeSet<$.RangeType<$number>>> = $.$expr_Function<
	$number,
	$.Cardinality.Many
>;
type range_unpackλFuncExpr2<P1 extends $.TypeSet<$.RangeType<$number>>> = $.$expr_Function<
	$number,
	$.Cardinality.Many
>;
type range_unpackλFuncExpr3<P1 extends $.TypeSet<$.RangeType<_cal.$local_date>>> = $.$expr_Function<
	_cal.$local_date,
	$.Cardinality.Many
>;
...
function re_replace<
	...
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>,
	P3 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>,
>(namedArgs: NamedArgs, pattern: P1, sub: P2, str: P3): re_replaceλFuncExpr<NamedArgs, P1, P2, P3>;
/**
 * Replace matching substrings in a given string.
 */
function re_replace<
...
type str_lowerλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>> = $.$expr_Function<
	$str,
	$.cardutil.paramCardinality<P1>
>;
/**
...
type str_upperλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>> = $.$expr_Function<
	$str,
	$.cardutil.paramCardinality<P1>
>;
/**
...
type str_titleλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>> = $.$expr_Function<
	$str,
	$.cardutil.paramCardinality<P1>
>;
/**
...
type str_reverseλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>> =
	$.$expr_Function<$str, $.cardutil.paramCardinality<P1>>;
/**
...
type multirangeλFuncExpr<P1 extends $.TypeSet<$.ArrayType<$.RangeType<$anypoint>>>> =
	$.$expr_Function<
...
type range_is_emptyλFuncExpr<P1 extends $.TypeSet<$.RangeType<$anypoint>>> = $.$expr_Function<
	$bool,
	$.cardutil.paramCardinality<P1>
>;
type range_is_emptyλFuncExpr2<P1 extends $.TypeSet<$.MultiRangeType<$anypoint>>> = $.$expr_Function<
	$bool,
	$.cardutil.paramCardinality<P1>
>;
...
type range_get_upperλFuncExpr<P1 extends $.TypeSet<$.RangeType<$anypoint>>> = $.$expr_Function<
	$.getPrimitiveBaseType<P1['__element__']['__element__']>,
	$.cardutil.overrideLowerBound<$.cardutil.paramCardinality<P1>, 'Zero'>
>;
type range_get_upperλFuncExpr2<P1 extends $.TypeSet<$.MultiRangeType<$anypoint>>> =
	$.$expr_Function<
		$.getPrimitiveBaseType<P1['__element__']['__element__']>,
		$.cardutil.overrideLowerBound<$.cardutil.paramCardinality<P1>, 'Zero'>
	>;
...
type range_get_lowerλFuncExpr<P1 extends $.TypeSet<$.RangeType<$anypoint>>> = $.$expr_Function<
	$.getPrimitiveBaseType<P1['__element__']['__element__']>,
	$.cardutil.overrideLowerBound<$.cardutil.paramCardinality<P1>, 'Zero'>
>;
type range_get_lowerλFuncExpr2<P1 extends $.TypeSet<$.MultiRangeType<$anypoint>>> =
	$.$expr_Function<
		$.getPrimitiveBaseType<P1['__element__']['__element__']>,
		$.cardutil.overrideLowerBound<$.cardutil.paramCardinality<P1>, 'Zero'>
	>;
...
type range_is_inclusive_upperλFuncExpr<P1 extends $.TypeSet<$.RangeType<$anypoint>>> =
	$.$expr_Function<$bool, $.cardutil.paramCardinality<P1>>;
type range_is_inclusive_upperλFuncExpr2<P1 extends $.TypeSet<$.MultiRangeType<$anypoint>>> =
	$.$expr_Function<$bool, $.cardutil.paramCardinality<P1>>;
function range_is_inclusive_upper<P1 extends $.TypeSet<$.RangeType<$anypoint>>>(
	r: P1
): range_is_inclusive_upperλFuncExpr<P1>;
function range_is_inclusive_upper<P1 extends $.TypeSet<$.MultiRangeType<$anypoint>>>(
	r: P1
...
type range_is_inclusive_lowerλFuncExpr<P1 extends $.TypeSet<$.RangeType<$anypoint>>> =
	$.$expr_Function<$bool, $.cardutil.paramCardinality<P1>>;
type range_is_inclusive_lowerλFuncExpr2<P1 extends $.TypeSet<$.MultiRangeType<$anypoint>>> =
	$.$expr_Function<$bool, $.cardutil.paramCardinality<P1>>;
function range_is_inclusive_lower<P1 extends $.TypeSet<$.RangeType<$anypoint>>>(
	r: P1
): range_is_inclusive_lowerλFuncExpr<P1>;
function range_is_inclusive_lower<P1 extends $.TypeSet<$.MultiRangeType<$anypoint>>>(
	r: P1
...
type multirange_unpackλFuncExpr<P1 extends $.TypeSet<$.MultiRangeType<$number>>> = $.$expr_Function<
	$.RangeType<$number>,
	$.Cardinality.Many
>;
type multirange_unpackλFuncExpr2<P1 extends $.TypeSet<$.MultiRangeType<$number>>> =
	$.$expr_Function<$.RangeType<$number>, $.Cardinality.Many>;
type multirange_unpackλFuncExpr3<P1 extends $.TypeSet<$.MultiRangeType<$number>>> =
	$.$expr_Function<$.RangeType<$number>, $.Cardinality.Many>;
type multirange_unpackλFuncExpr4<P1 extends $.TypeSet<$.MultiRangeType<$number>>> =
	$.$expr_Function<$.RangeType<$number>, $.Cardinality.Many>;
type multirange_unpackλFuncExpr5<P1 extends $.TypeSet<$.MultiRangeType<$decimalλICastableTo>>> =
	$.$expr_Function<$.RangeType<$decimal>, $.Cardinality.Many>;
type multirange_unpackλFuncExpr6<P1 extends $.TypeSet<$.MultiRangeType<$datetime>>> =
...
type multirange_unpackλFuncExpr8<P1 extends $.TypeSet<$.MultiRangeType<_cal.$local_date>>> =
...
function multirange_unpack<P1 extends $.TypeSet<$.MultiRangeType<$decimalλICastableTo>>>(
	val: P1
...
function multirange_unpack<P1 extends $.TypeSet<$.MultiRangeType<_cal.$local_date>>>(
	val: P1
...
type to_strλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$bytes>>> = $.$expr_Function<
	$str,
	$.cardutil.paramCardinality<P1>
>;
...
type to_bytesλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>> = $.$expr_Function<
	$bytes,
	$.cardutil.paramCardinality<P1>
>;
/**
...
type to_jsonλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>> = $.$expr_Function<
	$json,
	$.cardutil.paramCardinality<P1>
>;
/**
...
type sequence_resetλFuncExpr<P1 extends $.TypeSet<_schema.$ScalarType>> = $.$expr_Function<
	$number,
	$.cardutil.paramCardinality<P1>
>;
...
type to_datetimeλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>> =
...
> = $.$expr_Function<
	...
	>
>;
type to_datetimeλFuncExpr4<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$decimalλICastableTo>>> =
	$.$expr_Function<$datetime, $.cardutil.paramCardinality<P1>>;
 ...
 * Create a `datetime` value.
 */
function to_datetime<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$decimalλICastableTo>>>(
	epochseconds: P1
...
type sequence_nextλFuncExpr<P1 extends $.TypeSet<_schema.$ScalarType>> = $.$expr_Function<
	$number,
	$.cardutil.paramCardinality<P1>
>;
