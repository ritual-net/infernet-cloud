...
function to_date_duration(...args: any[]) {
	const {
		...
		args: positionalArgs,
		namedArgs,
	} = _.syntax.$resolveOverload('cal::to_date_duration', args, _.spec, [
		{
			args: [],
			namedArgs: {
				years: {
...
function duration_normalize_hours(...args: any[]) {
	const {
		...
		args: positionalArgs,
		namedArgs,
	} = _.syntax.$resolveOverload('cal::duration_normalize_hours', args, _.spec, [
		{
			args: [
				{
 ...
 */
function duration_normalize_days<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$date_duration>>>(
	dur: P1
...
function duration_normalize_days(...args: any[]) {
	const {
		...
		args: positionalArgs,
		namedArgs,
	} = _.syntax.$resolveOverload('cal::duration_normalize_days', args, _.spec, [
		{
			args: [
				{
