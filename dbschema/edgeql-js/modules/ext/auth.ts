...
const OAuthProviderConfig: $.$expr_PathNode<
	...
	null
> = _.syntax.$PathNode($.$toSet($OAuthProviderConfig, $.Cardinality.Many), null);
...
export type $IdentityλShape = $.typeutil.flatten<
	$AuditableλShape & {
		...
		'<identity[is User]': $.LinkDesc<
			...
			false
		>;
		'<identity[is __default::current_user]': $.LinkDesc<
			__default_10.$current_user,
			$.Cardinality.Many,
			{},
			false,
			false,
			...
			false
		>;
		'<identity[is current_user]': $.LinkDesc<
			_default.$current_user,
			$.Cardinality.Many,
			{},
			false,
			false,
...
const ClientTokenIdentity: $.$expr_PathNode<
	...
	null
> = _.syntax.$PathNode($.$toSet($ClientTokenIdentity, $.Cardinality.Many), null);
...
const Factor: $.$expr_PathNode<$.TypeSet<$Factor, $.Cardinality.Many>, null> = _.syntax.$PathNode(
	$.$toSet($Factor, $.Cardinality.Many),
	null
);
...
const EmailPasswordFactor: $.$expr_PathNode<
	...
	null
> = _.syntax.$PathNode($.$toSet($EmailPasswordFactor, $.Cardinality.Many), null);
...
const EmailPasswordProviderConfig: $.$expr_PathNode<
	...
	null
> = _.syntax.$PathNode($.$toSet($EmailPasswordProviderConfig, $.Cardinality.Many), null);
...
const GitHubOAuthProvider: $.$expr_PathNode<
	...
	null
> = _.syntax.$PathNode($.$toSet($GitHubOAuthProvider, $.Cardinality.Many), null);
...
const GoogleOAuthProvider: $.$expr_PathNode<
	...
	null
> = _.syntax.$PathNode($.$toSet($GoogleOAuthProvider, $.Cardinality.Many), null);
...
type signing_key_existsλFuncExpr = $.$expr_Function<_std.$bool, $.Cardinality.One>;
...
function jwt_check_signature_afb44ddf133051a39d0871812371dd10(...args: any[]) {
	const {
		...
		args: positionalArgs,
		namedArgs,
	} = _.syntax.$resolveOverload('ext::auth::_jwt_check_signature', args, _.spec, [
		{
			args: [
				{
...
function jwt_verify_75faa5ad758d5502bb04da9b92b99f58<
	...
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>,
	P3 extends _.castMaps.orScalarLiteral<$.TypeSet<$JWTAlgo>> | undefined,
>(token: P1, key: P2, algo?: P3): jwt_verify_75faa5ad758d5502bb04da9b92b99f58λFuncExpr<P1, P2, P3>;
