...
export type $AbstractConfigλShape = $.typeutil.flatten<
	$ConfigObjectλShape & {
		...
		'<cfg[is cfg::ExtensionConfig]': $.LinkDesc<
			...
			false
		>;
		'<cfg[is ext::auth::AuthConfig]': $.LinkDesc<
			_auth.$AuthConfig,
			$.Cardinality.AtMostOne,
			{},
			true,
			...
			false
		>;
		'<cfg[is ext::auth::SMTPConfig]': $.LinkDesc<
			_auth.$SMTPConfig,
			$.Cardinality.AtMostOne,
			{},
			true,
...
>;
type $JWT = $.ObjectType<'cfg::JWT', $JWTλShape, null, [...$AuthMethod['__exclusives__']]>;
...
>;
type $SCRAM = $.ObjectType<'cfg::SCRAM', $SCRAMλShape, null, [...$AuthMethod['__exclusives__']]>;
...
type $Trust = $.ObjectType<'cfg::Trust', $TrustλShape, null, [...$AuthMethod['__exclusives__']]>;
