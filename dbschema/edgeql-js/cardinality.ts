...
export namespace cardutil {
	...
	type _multiplyCardinalitiesVariadic<Cards extends [Cardinality, ...Cardinality[]]> =
					...
					? B extends Cardinality
						? Rest extends Cardinality[]
							? multiplyCardinalities<A, B> extends Cardinality
								? _multiplyCardinalitiesVariadic<[multiplyCardinalities<A, B>, ...Rest]>
								: never
							: never
						: never
					: never
	...
	export type multiplyCardinalitiesVariadic<Cards extends [Cardinality, ...Cardinality[]]> =
		_multiplyCardinalitiesVariadic<Cards> extends Cardinality
			? _multiplyCardinalitiesVariadic<Cards>
			: never;

	export function multiplyCardinalitiesVariadic<Cards extends [Cardinality, ...Cardinality[]]>(
		cards: Cards
	): multiplyCardinalitiesVariadic<Cards> {
	...
	export function mergeCardinalities<A extends Cardinality, B extends Cardinality>(
		a: A,
		b: B
	): mergeCardinalities<A, B> {
	...
	type _mergeCardinalitiesVariadic<Cards extends [Cardinality, ...Cardinality[]]> = Cards extends [
		infer Card,
	]
		? Card
		: Cards extends [infer A, infer B, ...infer Rest]
	...
	export type mergeCardinalitiesVariadic<Cards extends [Cardinality, ...Cardinality[]]> =
		_mergeCardinalitiesVariadic<Cards> extends Cardinality
			? _mergeCardinalitiesVariadic<Cards>
			: never;
	export function mergeCardinalitiesVariadic<Cards extends [Cardinality, ...Cardinality[]]>(
		cards: Cards
	): mergeCardinalitiesVariadic<Cards> {
		if (cards.length === 0) throw new Error('Empty tuple not allowed');
		if (cards.length === 1) return cards[0] as any;
		...
		return mergeCardinalitiesVariadic([mergeCardinalities(first, second), ...rest]);
	}
	...
	export type orCardinalities<C1 extends Cardinality, C2 extends Cardinality> = C1 extends C2
		? C1
		: C1 extends Cardinality.Many
			? C1
			: C1 extends Cardinality.AtMostOne
	...
	export type overrideLowerBound<C extends Cardinality, O extends 'One' | 'Zero'> = O extends 'One'
	...
	export function overrideLowerBound<C extends Cardinality, O extends 'One' | 'Zero'>(
		card: C,
		override: O
	): overrideLowerBound<C, O> {
		if (override === 'One') {
	...
	export type overrideUpperBound<C extends Cardinality, O extends 'One' | 'Many'> = O extends 'One'
		? C extends Cardinality.Many
			? Cardinality.AtMostOne
			: C extends Cardinality.AtLeastOne
				? Cardinality.One
	...
	export function overrideUpperBound<C extends Cardinality, O extends 'One' | 'Many'>(
		card: C,
		override: O
	): overrideUpperBound<C, O> {
		if (override === 'One') {
