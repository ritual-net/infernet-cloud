...
export function optional<Type extends ParamType>(type: Type): $expr_OptionalParam<Type> {
	return {
		__kind__: ExpressionKind.OptionalParam,
		__type__: type,
	};
...
>(
	...
	for (const [key, param] of Object.entries(paramsDef)) {
		...
		paramExprs[key] = $expressionify({
			...
			__cardinality__:
				param.__kind__ === ExpressionKind.OptionalParam ? Cardinality.AtMostOne : Cardinality.One,
			__name__: key,
