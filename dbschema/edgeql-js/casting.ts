...
> = setToAssignmentExpression<TypeSet<Pointer['target'], Pointer['cardinality']>, IsSetModifier>;

export type setToAssignmentExpression<Set extends TypeSet, IsSetModifier extends boolean> = [
	Set,
...
export type pointerToCastableExpression<Pointer extends PropertyDesc | LinkDesc> = [
	Pointer,
